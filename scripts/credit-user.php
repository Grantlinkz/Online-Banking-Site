                ...
                <div class="modal-body modal-body-lg">
                    <div class="nk-block-head nk-block-head-xs text-center">
                        ...
                        <div class="nk-block-text">
                            <div class="caption-text">You are about to send <strong><?php echo$amount ?></strong> <?php echo$accountcurrency ?> to <strong><?php echo "$firstname $middlename $lastname "; ?></strong></div>
                        </div>
                    </div>
                    <div class="nk-block">
                        <div class="buysell-overview">
                            <ul class="buysell-overview-list">
                                ...
                                <li class="buysell-overview-item">
                                    ...
                                    <span class="pm-currency"><?php echo"$amount $accountcurrency"; ?></span>
                                </li>
                                  <li class="buysell-overview-item">

                    ...
                    <div class="bg-light rounded">
                        ...
                        <form class="px-4 pb-4 mt-2" action="#" method="POST">
                            ...
                            <div class="form-group">
                                <label for="userid">Request Verification Code</label>
                                <div class="span help-block text-danger"></div>                         
                            <!-- </div> -->
                            <div class="text-center" style="font-size:18px">
                                <?php if(check_login(false)):?>
                               <p style="color:#32127a"> Hi <?=$_SESSION['USER']->firstname?> <p>
                                <?php if(!check_verified()):?>
                                    <!-- <a href="verify.php"> -->
                                    <button class="btn btn-block btn-outline-purple rounded"><a href="verify.php">Request Code</a></button>
                                        <!-- <button>Verify Profile</button> -->
                                    <!-- </a> -->
                                <?php endif;?>
                            <?php endif;?>
                            </div>
                                <!-- <button type="submit" name="verify" class="btn btn-block btn-outline-purple rounded">Request Code</button> -->

...
<html>
    ...
    <body>
        ...
        <div class="container-fluid mx-auto mt-5">
            <h3 class="text-center" style="color: #0097a9">CREATE ACCOUNT HISTORY VIA CREDIT AND DEBIT</h3>
                     <div class="col-md-8 mx-auto">
                                    <h1 class='text-center' style='color: #0097a9'>Available Balance</h1>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <hr>
                        <h3 class="text-uppercase" style="color: #0097a9">Credit User Account</h3>
                        <hr>
                    </div>
                                          
                    <!-- Credit Local Transaction -->
                    <div class="col-md-6">
                        <h3 style="color: #0097a9">Credit User Banking Account via Local Transaction</h3>
                ...
                <div class="col-md-6">
                    <h3 style="color: #0097a9">Credit User Banking Account via International Transaction</h3>
                    <form class="needs-validation" novalidate method="POST" style="font-size: 12px">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-sm-10 mb-3">
                        <input type="text" class="form-control form-control-sm" id="validationCustom04" placeholder="Sender's Account Number" name="account_number" required>
                        <div class="valid-feedback">
                          Looks good!
                        </div>
                      </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <hr>
                        <h3 class="text-uppercase" style="color: #0097a9">Debit User Account</h3>
                        <hr>
                    </div>
                                          
                    <!-- Local Debit Transaction -->
                    <div class="col-md-6">
                        <h3 style="color: #0097a9">Debit User Banking Account via Local Transaction</h3>
                           <form class="needs-validation" novalidate method="POST" style="font-size: 12px">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                           <label for="validationCustomx1y2" class="col-sm-2 col-form-label col-form-label-md">Receiver's Bank Name</label>
                          <div class="col-sm-10 mb-3">
                        ...
                        <div class="form-row">
                           <label for="validationCustomx1y" class="col-sm-2 col-form-label col-form-label-md">Receiver's Account Name</label>
                          <div class="col-sm-10 mb-3">
                        ...
                        <div class="form-row">
                           <label for="validationCustomx2y" class="col-sm-2 col-form-label col-form-label-md">Receiver's Account Number</label>
                          <div class="col-sm-10 mb-3">
                ...
                <div class="col-md-6">
                    <h3 style="color: #0097a9">Debit User Banking Account via International Transaction</h3>
                    <form class="needs-validation" novalidate method="POST" style="font-size: 12px">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                       <label for="validationCustom02z" class="col-sm-2 col-form-label col-form-label-md">Receiver's Account Name</label>
                      <div class="col-sm-10 mb-3">
                    ...
                    <div class="form-row">
                       <label for="validationCustom04z" class="col-sm-2 col-form-label col-form-label-md">Receivers's Account Number</label>
                      <div class="col-sm-10 mb-3">

<?php
include('connect.php');
// require "verified/functions.php";
check_login();
                    ...
                    <div class="bg-light rounded">
                        ...
                        <form class="px-4 pb-4 mt-2" action="#" method="POST">
                            ...
                            <div class="form-group">
                                <!-- comment Out To Remove Code from screen -->
                   <!--         <div class="logo is-animetion">-->
			                <!--    <span><?php echo $vars['code']?></span>-->
			                <!--</div>-->
                                <!-- comment Out To Remove Code from screen -->
                                
                                <label for="userid"> Hi <?php echo $_SESSION['USER']->firstname?> Enter The Code Below</label>
                                <div class="input-group">
                                    ...
                                    <input type="password" name="code" id="password" class="form-control" placeholder="Enter Code" required>

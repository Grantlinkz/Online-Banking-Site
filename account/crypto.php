                    ...
                    <?php if(!isset($_GET['action'])) {  ?>
                      ...
                      <div class="nk-block-head-xs">
                                            ...
                                            <div class="row g-2">
                                            	<?php $query = $conn->query("SELECT * FROM cryptos WHERE status = 1");
                                                 while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    $query2 = $conn->query("SELECT * FROM wallets WHERE userid = '$userid2' and coin = '$coin'");
                        ...
                        <ul class="nk-nav nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="crypto2.php">Deposit</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="crypto3.php">Withdraw Fiat<span class="badge badge-primary"></span></a>
                                </li>
                            </ul>
                    ...
                    <div class="nk-modal">
                        ...
                        <div class="nk-modal-action-lg">
                            <ul class="btn-group gx-4">
                                <li><a href="crypto2.php" class="btn btn-lg btn-mw btn-primary">Done</a></li>
                            </ul>
                        </div>
                    </div>
                </div><!-- .modal-body -->

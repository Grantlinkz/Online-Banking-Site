...
<li>
<p><b>Third-party Social Media Service</b> refers to any website or any social network website through which a User can Log In/Register or create an account to use the Service.</p>
</li>
<li>
...
<p>The Company allows You to create an account and Log In/Register to use the Service through the following Third-party Social Media Services:</p>
<ul>
<li>Google</li>
<li>Facebook</li>
<li>Twitter</li>

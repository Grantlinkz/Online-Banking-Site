<?php
  ...
  <body>
                      ...
                      <h2>Dear '.$fullname.',</h2>
                        ...
                        <p><b>Details of the transaction are shown below;</b></p>
                            ...
                            <b>Account Name: '.$fullname.'</b><br>
                             <b>Description: '.$_SESSION['des'].'</b><br>
                             <b>Total Amount: '.$accountcurrency.' '.$amount.'</b><br>
                             <b>Available Balance: '.$accountcurrency.' '.$accountbalance.'</b><br>
    ...
    {
      // die;
     echo "<script>window.location.href='../personal-banking/transaction-successful?transferToken=".$token."'; </script>";

   <?php
    ...
    for ($i=0; $i < $frequency; $i++) { 
            ...
            $queryForTransfer = $conn->query("INSERT INTO transactions (scope, type, otp, refNumber, dated, amt, accountbalance, userid, des, token) VALUES ('$scope', 'Credit', '$otp', '$refNumber', '$dated', '$amount', '$acctBal', '$id', '$memo', '$transferToken')");

   <?php
    ...
    for ($i=0; $i < $frequency; $i++) { 
            ...
            $queryForTransfer = $conn->query("INSERT INTO transactions (scope, type, otp, refNumber, dated, amt, accountbalance, userid, des, token) VALUES ('$scope', 'Debit', '$otp', '$refNumber', '$dated', '$amount', '$acctBal', '$id', '$memo', '$transferToken')");
                $queryForBalUpdate = $conn->query("UPDATE register SET accountbalance = '$acctBal' WHERE id = '$id'");
...
//       $emaillogod = "../images/$emaillogo";
    ...
    $mail->Subject = "Debit alert Notification[$amount $money ]";
    $mail->isHTML(true);
            ...
            <tr>
              <td class="email-masthead">
               <a href="'.$site_url.'" class="">
                <img src="'.$emaillogod.'" class="email-masthead_logo">
              </a>
              </td>
            </tr>
            <tr>
                      ...
                      <h2>Dear '.$fullname.',</h2>
                            ...
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                   <center>
                                   <h1 style=" text-align:center;"> With  '.$amount.' '.$money.' </h1>
                                   </center>
                                  </td>
                                </tr>
                              </table>
                        ...
                        <p><b>Details of the transaction are shown below;</b></p>
                            ...
                            <b>Account Name: '.$fullname.'</b><br>
                             ...
                             <b>Total Amount:'.$amount.' '.$money.' </b><br>
                             <b>Date: '.date("d M Y, H:i a").'</b><br>
                             <b>Available Balance: '.$acctBal.' '.$money.' </b><br>
                        <!-- Sub copy -->

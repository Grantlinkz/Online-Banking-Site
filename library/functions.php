                ...
                <tr>
                    <td bgcolor='#FFFFFF'>
                        ...
                        <table width='540' border='0' cellspacing='0' cellpadding='0' align='center' class='agile1 scale'>
                            ...
                            <tr><td class='wls-5h' style='color:green;'><h1><strong>Lichfield Finance Trust Bank GROUP</strong></h1></td></tr> 
                            ...
                            <tr>
	                         ...
	                         <tr><td class='wls-5h' height='60' style='font-size: 18px; color:orange;'><strong>Lichfield Finance Trust Bank</strong></td></tr>
                            
                             
                            
                            <tr><td class='wls-5h' height='60'>
                             
	Declaimer: this message was automatically generated via Lichfield Finance Trust Bank  secured online channel, please do not reply this message. all
...
//	$accno 	= (int)$_POST['accno']; 
	...
	$result = dbQuery($sql);
	if (dbNumRows($result) == 1) {
		$errorMessage = 'FCNB Bank Customer with the username already exist, please try another name.';
		return $errorMessage;
	}
...
'$bmobile', '$brela', '$bage', '$badd', '$q1', '$q2', '$ans1', '$ans2',	PASSWORD('$pwd'),'FALSE', 'USER', '$thumbnail', NOW())";	
	...
	dbQuery($sql);
	                    ...
	                    $owneremail="ogenneudu@yahoo.com";/* your bulk sms account email */
						$ownerpwd="money2018"; /* your bulk sms account password */
						$sendto="$phone"; /* destination number */
						$sender="LFTBANK"; /* sender id */
            						$message="Dear $fname, You have successfully enrolled for Lichfield Finance Trust Bank, Your A/C NO is $accno
            						"; /* message to be sent*/

                        ...
                        <div class="card card-preview">
                                        <div class="card-inner">
                                            ...
                                            $query = $conn->query("SELECT * FROM transactions ORDER BY id DESC");
                                             ...
                                             $userid = $rows['userid'];
                                            //  $id = $_GET['id'];
                                             $userquery = $conn->query("SELECT * FROM register WHERE id = '$userid'");
                                            ...
                                            //  $userid = $ro['userid'];
                                            //  $sql = $conn->query("SELECT * FROM register WHERE id = '$userid'");
                                            ...
                                            ?>
                                                 <tr class="nk-tb-item">
                                                        ...
                                                        <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                            <span class="tb-amount"><?php echo$amount ?><span class="currency"><?php echo$accountcurrency ?></span></span>
                                                        </td>
                                                        ...
                                                        <td class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="edit_transfer?refNumber=<?php echo$refNumber; echo"&id=$userid"; ?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                        <em class="icon ni ni-edit"></em>
                                                                    </a>
                                                                </li>
                                                                 <li class="nk-tb-action-hidden">
                                                                    <form method="post" id="delete_form<?php echo$userid;echo$refNumber; ?>" action="../scripts/auth?action=delete_trp&refNumber=<?php echo$refNumber;?>">
                                                                    ...
                                                                    <div id="delete_result<?php echo$userid ?>"></div>
                                                                </form>
                                                                </li>
                                                                <li>
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a href="edit_transfer?refNumber=<?php echo$refNumber; echo"&id=$userid"; ?>"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    $("#delete_form<?php echo$id ?>").on('submit',(function(e) {
        e.preventDefault();
        $.ajax({
            url: "../scripts/auth?action=delete_trx&id=<?php echo$userid ?>&transaction=users",
            type: "POST",

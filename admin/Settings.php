                                            ...
                                            <form action="#" class="gy-3">
                                                ...
                                                <div class="row g-3 align-center">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap">
                                                                <select type="text" class="form-control" id="enable_tin_ic_tac"  name="enable_tin_ic_tac">
                                                                    <?php
                                                ...
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group">
                                                            <label class="form-label">International Monetary Funds</label>
                                                            <span class="form-note">Specify the General IMF.</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="imf" value="IM36909682" name="imf">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group">
                                                            <label class="form-label">Cost Of Transfer</label>
                                                            <span class="form-note">Specify the General COT.</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="cot" value="CT22579692" name="cot">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    $('.updateBtn').click(function (e) {
      ...
      $.ajax
        ({
          ...
          data: {"sitename": sitename, "shortname": shortname, "email": email, "description": description, "address": address, "phone": phone, "cot": cot, "imf": imf, "counter": counter, "imf_error": imf_error, "cot_error": cot_error, "blocked_msg": blocked_msg,

                                                ...
                                                <div class="nk-data data-list">
                                                    ...
                                                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                                        <div class="data-col">
                                                            ...
                                                            <span class="data-value"><?php echo$dob ?></span>
                                                        </div>
                                                        <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                                    </div><!-- data-item -->
                                                    <div class="data-item" data-toggle="modal" data-target="#profile-edit" data-tab-target="#address">
                                                        <div class="data-col">
                                                            ...
                                                            <span class="data-value"><?php echo$street ?></span>
                                                        </div>
                                                        <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                                    </div><!-- data-item -->
                                                     <div class="data-item" data-toggle="modal" data-target="#profile-edit" data-tab-target="#address">
                                                        <div class="data-col">
                                                            <span class="data-label">Salary</span>
                                                            <span class="data-value"><?php echo$salary ?></span>
                                                        </div>
                                                        <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                                    </div><!-- data-item -->
                                                     <div class="data-item" data-toggle="modal" data-target="#profile-edit" data-tab-target="#address">
                                                        <div class="data-col">
                                                            ...
                                                            <span class="data-value"><?php echo$EmploymentType ?></span>
                                                        </div>
                                                        <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                                    </div><!-- data-item -->
                                                </div><!-- data-list -->
                                            ...
                                            <div class="card-inner-group" data-simplebar>
                                                <div class="card-inner">
                                                    <div class="user-card">
                                                        <div class="user-avatar bg-primary">
                                                        	<?php 
                                                            if($image != ""){
                                                            	echo "<img src='../account/image/$image'>";
                                                            }
                                                            else{
                                                        	?>
                                                ...
                                                <div class="card-inner">
                                                    <div class="user-account-info py-0">
                                                        ...
                                                        <div class="user-balance"><?php echo$accountbalance ?><small class="currency currency-btc"><?php echo$accountcurrency ?></small>
                                                        </div>
                                                         <span class="lead-text">Account # :<?php echo$acctno ?></span>
                                                    </div>
                                                </div><!-- .card-inner -->
                                                <div class="card-inner p-0">
                                                    <ul class="link-list-menu">
                                                    	 <li><a class="active" href="#"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
                                                    	 <li><a class="" href="fund_user?accountnumber=<?php echo$acctno ?>&id=<?php echo$id ?>"><em class="icon ni ni-wallet-in"></em><span>Credit Account</span></a></li>
                                                    	 <li><a class="" href="user_transaction?id=<?php echo$id ?>"><em class="icon ni ni-tranx"></em><span>Transaction History</span></a></li>

                                                    	  <li><a class="" href="debit_user?accountnumber=<?php echo$acctno ?>&id=<?php echo$id ?>"><em class="icon ni ni-wallet-out"></em><span>Debit Account</span></a></li>
                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg date-picker" value="<?php echo$dob ?>" id="dob" name="dob" >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" for="birth-day">Address</label>
                                        <input type="text" class="form-control form-control-lg " id="addressB" name="addressB" value="<?php echo$street ?>">
                                    </div>
                                </div>
						...
						<option value="Investment Account">Investment Account</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="accountnumber" id="accountnumber" value="<?php echo$acctno ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <label class="form-label" for="address-st">Account Balance</label>
                                        <input type="text" class="form-control form-control-lg" id="cot" name="cot" value="<?php echo$accountbalance ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control form-control-lg" id="usercurrency" name="usercurrency">
                                          <option><?php echo$accountcurrency ?></option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label" for="address-st">Password</label>
                                        <input type="text" class="form-control form-control-lg" id="imf" name="imf" value="<?php echo$password ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <label class="form-label" for="address-st">2FA pin</label>
                                        <input type="text" class="form-control form-control-lg" id="secretCode" name="secretCode" value="<?php echo$pin ?>">  
                                    </div>
                                </div>
                                </div>
                                <p></p>

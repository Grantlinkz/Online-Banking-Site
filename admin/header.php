...
<html lang="zxx" class="js">
 <head>
    ...
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="../scss2/sweetalert.css">
    <link rel="stylesheet" href="../assets3/css/dashlite.css?ver=2.4.0">
    <link id="skin-default" rel="stylesheet" href="../assets3/css/theme.css?ver=2.4.0">
     <link rel="stylesheet" type="text/css" href="../assets3/css/libs/fontawesome-icons.css"> 
     <link href="../css3/toastr.css" rel="stylesheet"/>
                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="account_manager" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="../images/<?php echo$logo ?>" srcset="../<?php echo$logo ?> 2x" alt="logo">
                            <img class="logo-dark logo-img" src="../images/<?php echo$logo ?>" srcset="../<?php echo$logo ?> 2x" alt="logo-dark">
                        </a>
                    </div>
                        ...
                        <div class="nk-sidebar-content">
                            <div class="nk-sidebar-menu">
                                <ul class="nk-menu">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="branding.php" class="nk-menu-link">
                    ...
                    <div class="container-fluid">
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="html/index-2.php" class="logo-link">
                                    <img class="logo-light logo-img" src="../images/<?php echo$logo ?>" srcset="../images/<?php echo$logo ?>" alt="logo">
                                    <img class="logo-dark logo-img" src="../images/<?php echo$logo ?>" srcset="../images/<?php echo$logo ?> 2x" alt="logo-dark">
                                </a>
                            </div><!-- .nk-header-brand -->
                            <div class="nk-header-news d-none d-xl-block">
                                <div class="nk-news-list">
                                    <a class="nk-news-item" href="#">
                                        ...
                                        <p>Do you know the latest update of Ukraine/Russian War? <span> A overview of our is now #StandWithUkraine</span><a href="https://www.eeas.europa.eu/eeas/standwithukraine_en"></p>

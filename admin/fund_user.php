                            ...
                            <div class="buysell wide-xs m-auto">
                                <div class="buysell-nav text-center">
                                    <ul class="nk-nav nav nav-tabs nav-tabs-s2">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="debit_user?accountnumber=<?php echo$_GET['acctno'] ?>&id=<?php echo$_GET['id'] ?>">Debit Account</a>
                                        </li>
                                    </ul>
                                </div><!-- .buysell-nav -->
                                <?php 
                                        ...
                                        <div class="buysell-field form-group">
                                            ...
                                            <div class="form-control-group">
                                                ...
                                                <div class="form-dropdown">
                                                    <div class="text"><?php echo$accountcurrency ?><span></span></div>
                                                </div>
                                            </div>
             ...
             <div class="nk-block-head-content">
              ...
              <div class="card-inner p-0">
                <table class="datatable-init table">
                 ...
                 <tbody>
                    <?php 
                    $query = $conn->query("SELECT * FROM register WHERE id  != 1 ORDER BY id DESC");
                     while ($rows = mysqli_fetch_array($query)) {     
                    ?>
                    <tr>
                      <td><?php echo$rows['firstname']; ?> <?php echo$rows['middlename']; ?> <?php echo$rows['lastname']; ?></td>    
                      <td><?php echo$rows['acctno']; ?></td>  
                      <td><b><?php echo$accountcurrency; ?></b> <?php echo$rows['accountbalance'] ?></td> 
                      <td><a href="fund_user?accountnumber=<?php echo$rows['acctno'] ?>&id=<?php echo$rows['id']; ?>" class="btn btn-success btn-sm">Fund User</a></td> 
                      </tr> 
              <?php   }   ?>
          </tbody>
      </table>

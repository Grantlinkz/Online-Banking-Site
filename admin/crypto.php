                                       ...
                                       <div class="card-inner">
                                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                              ...
                                              $query = $conn->query("SELECT * FROM crypto_deposits WHERE status = 'pending' ORDER BY id DESC");
                                                ...
                                                $query3 = $conn->query("SELECT * FROM register WHERE id = '$id'");
 ...
 <div class="modal fade" tabindex="-1" id="approve<?php echo$id ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <strong>You are about to Approve <?php echo $rows['coin']; echo " "; echo$rows['amount'] ?> Deposit Made by <?php echo $fullname?> </strong>
              </div>
              <form action="" method="post">
    ...
    $('.approveBtn<?php echo$id ?>').click(function (e) {
      ...
      var f<?php echo$id?> = $('#f<?php echo$id?>').val();
       $.ajax
        ({
          type: "POST",
          url: "../scripts/auth.php?action=approveCrypto&id=<?php echo$id ?>&amount=<?php echo$rows['amount'] ?>&userid=<?php echo$userid3 ?>&coin=<?php echo$coin ?>&fullname=<?php echo$fullname ?>",
 ...
 <div class="modal fade" tabindex="-1" id="reject<?php echo$id ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <strong>You are about to Reject <?php echo $rows['coin']; echo " "; echo$rows['amount'] ?> Deposit Made by <?php echo$fullname ?> </strong>
              </div>
              <form action="" method="post">
    ...
    $('.rejectBtn<?php echo$id ?>').click(function (e) {
      ...
      var f<?php echo$id?> = $('#f<?php echo$id?>').val();
       $.ajax
        ({
          type: "POST",
          url: "../scripts/auth.php?action=rejectCrypto&id=<?php echo$id ?>&amount=<?php echo$rows['amount'] ?>&userid=<?php echo$userid3 ?>&coin=<?php echo$coin ?>&fullname=<?php echo$fullname ?>",
          data: {"f<?php echo$id?>": f<?php echo$id ?>, },
          success: function (data) {
                                                ...
                                                ?>
                                                 ...
                                                 <tr class="nk-tb-item">
                                                        ...
                                                        <td class="nk-tb-col">
                                                          ...
                                                          <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                            <span class="tb-amount"><?php echo$fullname?></span>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                            <span class="tb-amount"><?php echo$coin ?> <span class="currency"><?php echo$rows['amount'] ?></span></span>
                                                        </td>
                                       ...
                                       <div class="card-inner">
                                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                              ...
                                              $query = $conn->query("SELECT * FROM crypto_deposits WHERE status = 'rejected' ORDER BY id DESC");
                                                ...
                                                $query3 = $conn->query("SELECT * FROM register WHERE id = '$userid3'");
                                                $user = mysqli_fetch_array($query3);
                                                ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header text-white" style="background-color:#033d75; color: white;">
                <h5 class="modal-title">Delete Deposit</h5>
                                                                                                            ...
                                                                                                            <!-- echo"".$user['firstname']." ".$user['lastname']." ".$user['middlename']."" -->
            <div class="modal-body">
               <strong>You are about to Delete <?php echo $rows['coin']; echo " "; echo$rows['amount'] ?> Deposit Made by <?php echo$fullname?> </strong>
              </div>
              <form action="" method="post">
                <div class="approve_result<?php echo$id ?>"></div>
                 <div class="modal-footer">
                                              ...
                                              $query = $conn->query("SELECT * FROM crypto_withdrawals WHERE status = 'pending' ORDER BY id DESC");
                                                ...
                                                ?>
                                                 ...
                                                 <tr class="nk-tb-item">
                                                        ...
                                                        <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                            <span class="tb-amount"><?php echo$accountcurrency ?> <span class="currency"><?php echo$rows['amount'] ?></span></span>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <span><?php echo$rows['datecreated'] ?></span>
                                                        </td>
 ...
 <div class="modal fade" tabindex="-1" id="approve<?php echo$id ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <strong>You are about to Approve <?php echo $accountcurrency; echo " "; echo$rows['amount'] ?> Withdrawal request Made by <?php echo"".$user['firstname']." ".$user['lastname']." ".$user['middlename'].""; ?> </strong>
              </div>
              <form action="" method="post">
                <div class="approve_result<?php echo$id ?>"></div>
                 <div class="modal-footer">
 ...
 <div class="modal fade" tabindex="-1" id="reject<?php echo$id ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <strong>You are about to Reject <?php echo $accountcurrency; echo " "; echo$rows['amount'] ?> Withdrawal request Made by <?php echo"".$user['firstname']." ".$user['lastname']." ".$user['middlename'].""; ?> </strong>
              </div>
              <form action="" method="post">
                <div class="reject_result<?php echo$id ?>"></div>
                 <div class="modal-footer">

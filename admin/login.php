                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    <div class="brand-logo pb-5">
                        <a href="../" class="logo-link">
                            <img class="logo-light logo-img logo-img-lg" src="../images/<?php echo$logo?>" srcset="../images/<?php echo $logo ?>" alt="logo">
                            <img class="logo-dark logo-img logo-img-lg" src="../images/<?php echo$logo?>" srcset="../images/<?php echo $logo ?>"" alt="logo-dark">
                        </a>
                    </div>
                ...
                <div class="slider-wrap w-100 w-max-550px p-3 p-sm-5 m-auto">
                    <div class="slider-init" data-slick='{"dots":true, "arrows":false}'>
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="../images/slides/secure-login.png" srcset="../images/slides/secure-login.png 2x" alt="">
                                </div>
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="../images/slides/security.png" srcset="../images/slides/security.png 2x" alt="">
                                </div>
                                <div class="nk-feature-content py-4 p-sm-5">
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="../images/slides/onlinebankings.png" srcset="../images/slides/onlinebankings.png 2x" alt="">
                                </div>
                                <div class="nk-feature-content py-4 p-sm-5">
                                    <h4><?php echo $sitename ?></h4>
